...
import "../App.css";
import makeCalendar from "../functions/CalenderFunc";
import dayStyle from "../functions/StyleFunc";
import { curMonth, curYear } from "../functions/YearAndMonth";
...
export default function Calendar() {
  ...
  return (
    <div className="mainDiv">
      <h1 className="name">Welcome to the Calander</h1>
      <div className="header">
        ...
        <div className="next">
          <div onClick={handleprevious}>{String.fromCharCode(171)}</div>{" "}
          <div onClick={handlenext}>{String.fromCharCode(187)}</div>
        </div>
        <div>
          {month} {year}
        </div>
